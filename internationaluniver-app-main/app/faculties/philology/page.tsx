...
import { ArrowLeft, Clock, Users, Award, Globe, Languages, PenTool, MessageCircle, Book, Play, CheckCircle } from "lucide-react"
...
function Glow() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      <div className="absolute -top-1/3 left-1/2 h-[80vh] w-[80vw] -translate-x-1/2 rounded-full bg-gradient-to-tr from-orange-500/30 via-amber-400/20 to-yellow-500/20 blur-3xl dark:from-orange-500/20 dark:via-amber-400/10 dark:to-yellow-500/10" />
      <div className="absolute bottom-[-20%] right-[-10%] h-[50vh] w-[50vw] rounded-full bg-gradient-to-tr from-red-500/20 via-pink-400/10 to-purple-500/10 blur-3xl" />
    </div>
  );
}
...
export default function PhilologyFaculty() {
  ...
  const programs = [
    {
      ...
      duration: "4 years",
      degree: "Bachelor",
      description: "Comprehensive English language studies with literature focus",
      specializations: ["Teaching English", "Translation", "Literature Studies", "Linguistics"],
    },
    {
      name: "Russian Language & Literature",
      duration: "4 years",
      degree: "Bachelor",
      description: "Russian language and literature program for international students",
      specializations: ["Russian Teaching", "Literary Analysis", "Cultural Studies", "Translation"],
    },
    {
      name: "Uzbek Language & Literature",
      duration: "4 years",
      degree: "Bachelor",
      description: "Native language studies and cultural heritage program",
      specializations: ["Uzbek Literature", "Cultural Studies", "Language Teaching", "Folklore Studies"],
    },
    {
      name: "Translation Studies",
      duration: "4 years",
      degree: "Bachelor",
      description: "Professional translation and interpretation program",
      specializations: ["Conference Interpreting", "Legal Translation", "Medical Translation", "Literary Translation"],
    },
  ]

  const admissionRequirements = [
    "High school diploma with minimum 80% in languages",
    "Strong language proficiency in chosen specialization",
    "IELTS 6.0 for English programs",
    "Literature and language background",
    "Writing sample or essay",
    "Oral interview in target language",
  ]

  const facilities = [
    {
      name: "Language Learning Center",
      description: "Modern language laboratory with audio-visual equipment",
      icon: <Languages className="h-6 w-6" />,
    },
    {
      name: "Translation Studio",
      description: "Professional translation and interpretation facilities",
      icon: <MessageCircle className="h-6 w-6" />,
    },
    {
      name: "Literary Archive",
      description: "Extensive collection of literary works and manuscripts",
      icon: <Book className="h-6 w-6" />,
    },
    {
      name: "Writing Center",
      description: "Creative writing and academic writing support center",
  ...
  return (
    <div className="min-h-screen bg-white font-mono text-zinc-900 selection:bg-orange-500 selection:text-white dark:bg-zinc-950 dark:text-zinc-100">
      ...
      <motion.div
        style={{ scaleX }}
        className="fixed left-0 top-0 z-[60] h-[3px] w-full origin-left bg-gradient-to-r from-orange-500 via-amber-400 to-yellow-500"
      />
      ...
      <section className="relative isolate overflow-hidden">
        ...
        <Image
          ...
          alt="Faculty of Philology - RANCH University"
          fill
          priority
        ...
        <div className="relative z-10 mx-auto grid min-h-[calc(100vh-64px)] w-full max-w-7xl grid-cols-1 items-center gap-10 px-4 py-16 md:px-8">
          ...
          <div className="max-w-2xl">
            ...
            >
              Exploring languages, literature, and cultures with comprehensive linguistic education
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 10 }}
              whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="border-b border-zinc-200 bg-zinc-50 py-16 dark:border-zinc-800 dark:bg-zinc-900 md:py-24">
        <div className="container mx-auto px-4 md:px-8">
          <SectionTitle
            ...
            description="Our Faculty of Philology is dedicated to the study of languages, literature, and cultures, fostering linguistic excellence and cultural understanding."
          />
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            >
              ...
              <div className="text-zinc-600 dark:text-zinc-300">800+ students</div>
            </motion.div>
            ...
            >
              ...
              <div className="font-semibold text-zinc-900 dark:text-zinc-100 mb-1">Cultural Focus</div>
              <div className="text-zinc-600 dark:text-zinc-300">Multilingual approach</div>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section id="programs" className="border-b border-zinc-200 bg-white py-16 dark:border-zinc-800 dark:bg-zinc-950 md:py-24">
        <div className="container mx-auto px-4 md:px-8">
          <SectionTitle
            ...
            description="Comprehensive language and literature programs designed to prepare students for successful careers in linguistics and cultural studies."
          />
      ...
      <section className="border-b border-zinc-200 bg-zinc-50 py-16 dark:border-zinc-800 dark:bg-zinc-900 md:py-24">
        <div className="container mx-auto px-4 md:px-8">
          <SectionTitle
            overline="Admission"
            title="Requirements"
            description="Academic and language requirements for admission to our philology programs."
          />
          ...
          >
            <div className="grid gap-4 md:grid-cols-2">
              {admissionRequirements.map((requirement, index) => (
                ...
                >
                  <div className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-orange-100 text-orange-600 dark:bg-orange-900 dark:text-orange-400">
      ...
      <section className="border-b border-zinc-200 bg-white py-16 dark:border-zinc-800 dark:bg-zinc-950 md:py-24">
        <div className="container mx-auto px-4 md:px-8">
          <SectionTitle
            ...
            description="State-of-the-art language learning facilities and resources to enhance your linguistic education."
          />
      ...
      <section className="relative flex min-h-[60vh] items-center justify-center overflow-hidden bg-black px-4 py-20 text-center text-white md:px-8">
        ...
        <div className="relative z-10 mx-auto max-w-3xl">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-zinc-300">
            Join our Faculty of Philology and become part of the next generation of language experts.
          </p>
