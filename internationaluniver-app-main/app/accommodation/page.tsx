...
import { ArrowLeft, Bed, Wifi, Car, Utensils, Shield, MapPin, DollarSign, Users, Play } from "lucide-react"
...
export default function AccommodationPage() {
  ...
  const accommodationOptions = [
    {
      name: t("universityDormitory"),
      type: t("onCampus"),
      price: t("dormitoryPrice"),
      capacity: t("dormitoryCapacity"),
      features: [
        t("sharedBathroom"),
        t("studyArea"),
        t("commonKitchen"),
    ...
    {
      name: t("internationalStudentHouse"),
      type: t("onCampus"),
      price: t("studentHousePrice"),
      capacity: t("studentHouseCapacity"),
      features: [
        t("privateBathroom"),
        t("airConditioning"),
        t("furnishedRoom"),
    ...
    {
      name: t("privateApartments"),
      type: t("offCampus"),
      price: t("apartmentsPrice"),
      capacity: t("apartmentsCapacity"),
      features: [t("fullKitchen"), t("privateBathroom"), t("livingRoom"), t("balcony"), t("parkingAvailable"), t("nearCampus")],
      image: "/images/medical-students.jpg",
      available: true,
    },
    {
      name: t("homestayProgram"),
      type: t("offCampus"),
      price: t("homestayPrice"),
      capacity: t("homestayCapacity"),
      features: [
        t("mealsIncluded"),
        t("culturalImmersion"),
        t("languagePractice"),
    ...
    <div className="min-h-screen bg-white font-mono text-zinc-900 selection:bg-orange-500 selection:text-white dark:bg-zinc-950 dark:text-zinc-100">
      ...
      <section className="relative isolate overflow-hidden">
        ...
        <Image
          ...
          alt="RANCH University Accommodation"
          fill
          priority
      ...
      <section className="border-b border-zinc-200 bg-zinc-50 py-16 dark:border-zinc-800 dark:bg-zinc-900 md:py-24">
        <div className="container mx-auto px-4 md:px-8">
          <SectionTitle
            overline={t("options")}
            title={t("housingOptions")}
            description={t("housingOptionsDescription")}
          />
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {accommodationOptions.map((option, index) => (
              <motion.div
                ...
                className="group relative overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-md transition hover:shadow-2xl dark:border-zinc-800 dark:bg-zinc-900"
              >
                <div className="relative aspect-[16/11] w-full">
                  ...
                  <div className="absolute left-4 top-4 inline-flex items-center gap-2 rounded-full bg-white/85 px-3 py-1 text-[10px] font-black uppercase tracking-widest text-zinc-700 backdrop-blur dark:bg-zinc-900/85 dark:text-zinc-100">
                    <Bed className="h-3.5 w-3.5" />
                    {option.type}
                  </div>
                  {!option.available && (
                    <div className="absolute right-4 top-4 rounded-full bg-red-500 px-3 py-1 text-[10px] font-bold uppercase text-white">
                      {t("full")}
                    </div>
                  )}
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-2 text-sm">
                    {option.features.slice(0, 4).map((feature) => (
                      <div key={feature} className="flex items-center gap-2 text-zinc-600 dark:text-zinc-300">
                  ...
                  <Button
                    className="mt-4 w-full rounded-xl border-2 border-orange-500 bg-orange-500 font-bold text-white transition hover:-translate-y-0.5 hover:bg-orange-600"
                    disabled={!option.available}
                  >
                    {option.available ? t("bookNow") : t("fullyBooked")}
                  </Button>
                </div>
